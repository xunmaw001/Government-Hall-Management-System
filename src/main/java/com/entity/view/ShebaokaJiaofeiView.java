...
public class ShebaokaJiaofeiView extends ShebaokaJiaofeiEntity implements Serializable {
	...
	public ShebaokaJiaofeiView() {

	}

	public ShebaokaJiaofeiView(ShebaokaJiaofeiEntity shebaokaJiaofeiEntity) {
		try {
			BeanUtils.copyProperties(this, shebaokaJiaofeiEntity);
