    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="用户唯一编号" prop="yonghuUuidNumber">
                       <el-input v-model="ruleForm.yonghuUuidNumber"
                                 placeholder="用户唯一编号" clearable  :readonly="ro.yonghuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="公积金余额" prop="gongjijinJine">
                       <el-input v-model="ruleForm.gongjijinJine"
                                 placeholder="公积金余额" clearable  :readonly="ro.gongjijinJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="公积金余额" prop="gongjijinJine">
                           <el-input v-model="ruleForm.gongjijinJine"
                                     placeholder="公积金余额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医保卡余额" prop="yibaoJine">
                       <el-input v-model="ruleForm.yibaoJine"
                                 placeholder="医保卡余额" clearable  :readonly="ro.yibaoJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="医保卡余额" prop="yibaoJine">
                           <el-input v-model="ruleForm.yibaoJine"
                                     placeholder="医保卡余额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuUuidNumber: [
                              { required: true, message: '用户唯一编号不能为空', trigger: 'blur' },
                          ],
                   yonghuName: [
                   ...
                   gongjijinJine: [
                              { required: true, message: '公积金余额不能为空', trigger: 'blur' },
                   ...
                   yibaoJine: [
                              { required: true, message: '医保卡余额不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
