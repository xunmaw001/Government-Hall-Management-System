<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='用户唯一编号' prop="yonghuUuidNumber">
               <el-input v-model="ruleForm.yonghuUuidNumber"  placeholder='用户唯一编号' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='公积金余额' prop="gongjijinJine">
               <el-input v-model="ruleForm.gongjijinJine" disabled  placeholder='公积金余额' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='医保卡余额' prop="yibaoJine">
               <el-input v-model="ruleForm.yibaoJine" disabled  placeholder='医保卡余额' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 用户 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.gongjijinJine)&& 'yonghu'==this.flag){
                             this.$message.error('公积金余额不能为空');
                             return
                         }

                         if((!this.ruleForm.yibaoJine)&& 'yonghu'==this.flag){
                             this.$message.error('医保卡余额不能为空');
                             return
                         }
